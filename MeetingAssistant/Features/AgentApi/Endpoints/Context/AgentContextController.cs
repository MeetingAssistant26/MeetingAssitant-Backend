...
namespace MeetingAssistant.Features.AgentApi.Endpoints.Context
{
    ...
    {
        protected readonly IAgentContextService _agentContextService = agentContextService;
        protected readonly IAgentAuthService _agentAuthService = agentAuthService;
