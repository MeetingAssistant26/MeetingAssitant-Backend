...
namespace MeetingAssistant.Features.ActionItems.Endpoints.Admin
{
    public partial class IntegrationAdminController
    {
        ...
        public async Task<IActionResult> ListProviderProjects(
            Guid organizationId,
            string provider,
            CancellationToken cancellationToken = default)
        {
            ...
            var result = await _integrationAdminService.GetProjectsAsync(organizationId, providerEnum, cancellationToken);
